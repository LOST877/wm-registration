...
Сайт рассчитан на использование с мобильных устройств — это приоритет при вёрстке. При любых доработках фронтенда обязательно учитывать:

- Адаптивная вёрстка: mobile-first, breakpoints через CSS media queries
- Все интерактивные элементы (кнопки, поля форм) — удобного размера для тапа (min 44px)
- Таблицы и длинные списки должны корректно отображаться на узких экранах (горизонтальный скролл или переформатирование)
- Проверять новый UI на ширине 320–480px
